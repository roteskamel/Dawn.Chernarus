...
_redMenArray2 = ["O_Soldier_A_F","O_soldier_AR_F","O_medic_F","O_engineer_F","O_soldier_exp_F","O_Soldier_GL_F","O_soldier_M_F","O_soldier_AA_F","O_soldier_AT_F","O_officer_F","O_soldier_repair_F","O_Soldier_F","O_soldier_LAT_F","O_Soldier_lite_F","O_Soldier_SL_F","O_Soldier_TL_F","O_soldier_AAR_F","O_soldier_AAA_F","O_soldier_AAT_F"];
_OPFarrays = [_redMenArray,_redMenArray2];
_greenMenArray = ["SUD_RU_Soldier_AT","SUD_RU_Soldier_AR","SUD_RU_Soldier_Engineer","SUD_RU_Soldier_P","SUD_RU_Soldier_GL","SUD_RU_Soldier_MG","SUD_RU_Soldier_Medic","SUD_RU_Soldier","SUD_RU_Soldier_Sapper","SUD_RU_Soldier_TL"];
