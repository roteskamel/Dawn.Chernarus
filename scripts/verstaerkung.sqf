...
_crew4 = creategroup west; 
_tank4 = [getMarkerPos "hmmwv1", 90, "DAR_M1167Woodland", _crew4] call BIS_fnc_spawnVehicle;
...
_crew5 = creategroup west; 
_tank5 = [getMarkerPos "hmmwv2", 90, "DAR_M1167Woodland", _crew5] call BIS_fnc_spawnVehicle;
...
_crew6 = creategroup west; 
_tank6 = [getMarkerPos "hmmwv3", 90, "DAR_M1167Woodland", _crew6] call BIS_fnc_spawnVehicle;
